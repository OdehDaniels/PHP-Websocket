...
<!-- Pixel CSS -->
<link type="text/css" href="@@path/css/neumorphism.css" rel="stylesheet">
...
<script src="@@path/vendor/waypoints/lib/jquery.waypoints.min.js"></script>
...
<script src="@@path/vendor/jquery-countdown/dist/jquery.countdown.min.js"></script>
<script src="@@path/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>
<script src="@@path/vendor/prismjs/prism.js"></script>

<script async defer src="https://buttons.github.io/buttons.js"></script>

<!-- Neumorphism JS -->
<script src="@@path/assets/js/neumorphism.js"></script>
</body>
